...
<html lang="en">
  <body>
    ...
    <?php
    $queryM="SELECT * FROM IS_REQUIREMENTS_STD WHERE REQUIREMENT = 'M'";
    ...
    <?php
    $queryR="SELECT * FROM IS_REQUIREMENTS_STD WHERE REQUIREMENT = 'R'";
    ...
    <?php
    $queryO="SELECT * FROM IS_REQUIREMENTS_STD WHERE REQUIREMENT = 'O'";
