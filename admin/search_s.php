...
<?php
  if (isset($_POST['submit-search'])) {
    ...
    $sql = "SELECT ID, EMAIL, FNAME, LNAME, PID, DEPARTMENT, MAJOR FROM population WHERE ID LIKE '%$search%' OR EMAIL LIKE '%$search%' OR FNAME LIKE '%$search%' OR LNAME LIKE '%$search%' OR MAJOR LIKE '%$search%' OR DEPARTMENT LIKE '%$search%' OR PID LIKE '%$search%'";
